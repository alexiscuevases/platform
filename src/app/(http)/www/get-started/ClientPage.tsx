  ...
  return (
    <div className="h-full min-h-screen w-full bg-gradient-to-b from-ambient-peach to-ambient-lavender">
      <main className="space-y-6 px-4 py-10">
        <div className="relative mx-auto max-w-[950px]">
          {step >= 2 ?
            <button
              ...
              className="absolute left-4 flex items-center gap-1 font-bold text-primary duration-200 hover:scale-105 hover:text-primary-dark">
        ...
        {step == 1 && <FirstStep setData={setData} data={data} setStep={setStep} />}
        {step == 2 && (
          <SecondStep setData={setData} data={data} setStep={setStep} step={step} setVerification={setVerification} />
        )}
        {step == 3 && (
          <ThirdStep
            setData={setData}
        ...
        {step == 4 && <FourthStep setData={setData} data={data} />}
      </main>
    </div>
  );
}
